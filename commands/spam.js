module.exports = {
    ...
    execute(message, args, bot) {
        if (args[1] !== undefined && args[1] !== '') {
            ...
            let command = message.content.substring(6).split("\\");
            ...
            spamMessage(message, command[0], amount);
        }
        else {
            message.channel.send('\"+spam\" must have a message inserted after the command');
        }
    }
}
